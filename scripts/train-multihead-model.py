"""
Multi-Head Amharic RoBERTa Training Script
==========================================
Three parallel output heads on rasyosef/roberta-base-amharic:
  1. Language Head    – Binary  (0: Other/Mixed, 1: Amharic)
  2. Readability Head – Binary  (0: Broken/OCR,  1: Clear)
  3. Domain Head      – 7-class (Education, Health, Religion, Politics, Law, General, Finance)

Strict hierarchical gating logic:
  • Language    → Always active (Universal gate)
...
Launch: accelerate launch --multi_gpu --num_processes=2 scripts/train-multihead-roberta.py
"""
...
DATA_PATH    = "/kaggle/input/datasets/amanuelfisseha/amharic-domain-sense/final_training_v3.jsonl"

OUTPUT_DIR = "/kaggle/working/roberta_base_amharic_model"
...
def main():
    ...
    if is_main:
        ...
        print("=" * 60)
        print("  Multi-Head RoBERTa-Amharic Trainer (DDP)")
        print("=" * 60)
    ...
    #  Model 
    model = MultiHeadRoberta(MODEL_NAME, NUM_DOMAINS)
...
if __name__ == "__main__":
    model, tokenizer, accelerator = main()
