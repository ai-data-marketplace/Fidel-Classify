...
DATA_PATH    = "/kaggle/input/datasets/amanuelfisseha/amharic-domain-classification-dataset/chunked_dataset.jsonl"  
OUTPUT_DIR   = "/kaggle/working/afriberta_amharic_model"
LOG_DIR      = "./logs"
MAX_LEN      = 256
BATCH_SIZE   = 16       
GRAD_ACCUM   = 2
...
ax.set_title("Confusion Matrix – AfriBERTa Amharic Classifier", fontsize=14)
